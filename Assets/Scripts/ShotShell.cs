...
public class ShotShell : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space))
        {
            ...
            Vector3 direction = transform.forward * shotSpeed + transform.up * upspeed;

            //direction = new Vector3(0, direction.y * upspeed, direction.z * shotSpeed);
            shellRb.AddForce(direction);
